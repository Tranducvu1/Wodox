...
import com.osprey.core.extension.runDelayed
import com.wodox.common.databinding.FragmentMediaPickerDialogBinding
...
import com.wodox.common.ui.appcamera.AppCameraActivity
...
import com.wodox.core.extension.FileUtils.fileExtension
import com.wodox.core.extension.dialogWidth
import com.wodox.core.extension.fileName
import com.wodox.core.extension.imageDir
import com.wodox.core.extension.saveTo
...
class MediaPickerDialogFragment :
    ...
    private fun showCrop(uri: Uri) {
        ...
        intent.putExtra(Constants.Intents.CROP_DATA, CropData(uri = uri))
    ...
    private fun getSaveFolder(): String {
        val folder = pickerOption?.folder
        val imageDirPath = requireContext().imageDir.path
