...
import com.wodox.main.databinding.ItemAiAssistantMessageAiBinding
import com.wodox.main.databinding.ItemAiAssistantMessageUserBinding
...
class AIAssistantAdapter(
    ...
    override fun onCreateViewHolderBase(
        ...
        return when (viewType) {
            VIEW_TYPE_USER -> {
                val binding = ItemAiAssistantMessageUserBinding.inflate(
                ...
                val binding = ItemAiAssistantMessageAiBinding.inflate(
                    LayoutInflater.from(parent?.context),
                    parent,
                    false
                )
    ...
    fun addAIMessageWithTyping(fullText: String) {
        ...
        val message = Message(text = "", isUser = false, timestamp = System.currentTimeMillis())
        list.add(message)
